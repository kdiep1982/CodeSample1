...
{{Html::script('js/core/jquery.placeholder.min.js')}}
{{Html::script('js/core/js.cookie.min.js')}}
{{Html::script('js/app.js')}}

{{Html::script('js/pages/base_comp_rating.js')}}
{{Html::script('js/plugins/jquery-raty/jquery.raty.min.js')}}
<!-- Page JS Plugins -->
{{Html::script('js/plugins/simplemde/simplemde.min.js')}}
...
<script>
    jQuery(function () {
        ...
        App.initHelpers(['appear', 'appear-countTo','simplemde']);
    });
</script>
